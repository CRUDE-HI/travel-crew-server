...
public enum MemberErrorCode {
	...
	NOTIFICATION_NOT_FOUND(HttpStatus.BAD_REQUEST, "E106", "알림이 존재하지 않습니다."),
	EMAIL_AUTH_CODE_NOT_FOUND(HttpStatus.BAD_REQUEST, "E107", "이메일 인증 코드가 존재하지 않습니다."),
	INTERNAL_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "E108", "토큰을 가져올 수 없습니다.");
